...
/**
   ...
   public Game() {
            ...
            while(!"finish".equals(keywords)){
                switch (keywords){
                    ...
                    case "desc":     // description of the role of an element
                        ...
                        word = keyboard.nextLine();
                        switch (word){
                            case "child": Child.description();
                                return false;
                            case "adult": Adult.description();
                                return false;
                            case "professor": Professor.description();
                                return false;
                            case "worker": Worker.description();
                                return false;
                            case "scientist":  Scientist.description();
                                return false;
                            case "police": Police.description();
                                return false;
    ...
    protected boolean decision(){
        ...
        System.out.println("La phase d'observation et dor�navant termin�e. Quelles d�cisions majeures pour " + townName + " alez vous prendre maintenant ?");
...
*/
    ...
    public void desc(){
        System.out.println("Dans desc, il y à les détails des informations globales sue votre jeu");
        System.out.println("Vous y trouverez les informations concernant chaques metiers ou chaques batiments");
        System.out.println("Mais aussi la compréhension du système du jeu dans les phases enfant/adulte de vos personnages ");
        System.out.println("");
